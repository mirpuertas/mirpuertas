...
| 🌱 **Bloomkeeper** | **WIP.** Juego de puzzles en Flutter/Dart sobre jardines generados, terrenos compatibles e hibridación de plantas. Explora reglas de juego, linajes híbridos, puntaje multicriterio, guardado local y arte procedural con `CustomPainter`. | Flutter, Dart |
