...
Flutter • SQLite (mobile) • UX orientado a producto
...
Me interesa desarrollar soluciones analíticas para problemas reales, combinando modelado estadístico, programación y visualización interpretable, con un enfoque en reproducibilidad y buenas prácticas de ingeniería de software, especialmente en contextos donde el rigor estadístico, la ingeniería de software y el diseño de producto se integran en soluciones reales y sostenibles.
...
|---|---|---|
| [📱 Mediary – Diario de salud offline](https://github.com/mirpuertas/mediary) | Aplicación mobile *privacy-first* para registrar sueño, ánimo y medicación. Funciona completamente offline, sin cuentas ni nube, con recordatorios locales, flujo rápido desde notificaciones y exportación de datos (CSV/PDF/XLSX). Proyecto personal enfocado en diseño de producto y UX. | Flutter, Dart, SQLite, Provider |
| [🩺 ATHomeRed – API para atención domiciliaria](https://github.com/mirpuertas/ATHomeRed) | API REST desarrollada con FastAPI para modelar una red de atención domiciliaria entre familias, pacientes y profesionales de salud. Proyecto académico grupal donde mi aporte principal estuvo orientado al manejo del repositorio, persistencia con SQLAlchemy, integración con Supabase/PostgreSQL, migraciones con Alembic, scripts auxiliares de base de datos y CI básica. | FastAPI, SQLAlchemy, Alembic, Supabase, PostgreSQL, Docker, Pytest |
...
## Proyectos en desarrollo y exploración
...
| 🚇 **Accesibilidad multimodal CABA (2001-2022)** | **WIP.** Caso de estudio de la red de transporte de la Ciudad Autónoma de Buenos Aires (subte, tren, Metrobus y colectivos). Muestra que una métrica clásica como “parada ≤ 800 m” está saturada (> 96 % cobertura) y ya no capta la inequidad real: la brecha actual se manifiesta en la **frecuencia del servicio** y el **tiempo puerta a puerta**. Incluye mapas comparativos 2001-2010-2022, un logit densidad × alta_bus y discusión metodológica sobre la necesidad de usar GTFS. | Python, GeoPandas, Statsmodels, QGIS |
| 🌱 **Hybrid Garden** | **WIP.** Juego de puzzles en Flutter/Dart sobre jardines generados, terrenos compatibles e hibridación de plantas. Explora reglas de juego, linajes híbridos, puntaje multicriterio, guardado local y arte procedural con `CustomPainter`. | Flutter, Dart |
| 🧩 **Optimal Path** | **WIP.** Puzzle de caminos mínimos en grilla donde el jugador compite contra la solución óptima calculada con Dijkstra. Incluye generación procedural, celdas ponderadas, obstáculos, scoring y progresión de dificultad. | Flutter, Dart, Dijkstra |
